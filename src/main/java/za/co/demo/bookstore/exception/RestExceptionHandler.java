...
import za.co.demo.bookstore.exception.apierror.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Handles InternalProcessingException.
     *
     * @param ex the InternalProcessingException
     * @return the ApiError object
     */
    @ExceptionHandler(InternalProcessingException.class)
    protected ResponseEntity<Object> handleInternalProcessingException(InternalProcessingException ex) {
    ...
    /**
     * Handles InvalidItemPriceException.
     *
     * @param ex the InvalidItemPriceException
     * @return the ApiError object
     */
    @ExceptionHandler(InvalidItemPriceException.class)
    protected ResponseEntity<Object> handleInvalidItemPriceException(InvalidItemPriceException ex) {
        ApiError apiError = new ApiError(BAD_REQUEST);
        apiError.setMessage(ex.getMessage());
        return buildResponseEntity(apiError);
    }
    ...
    protected ResponseEntity<Object> handleDataIntegrityViolation(DataIntegrityViolationException ex,
        ...
        if (throwable instanceof ConstraintViolationException
            ...
            return buildResponseEntity(new ApiError(HttpStatus.CONFLICT, "Database error", throwable));
        }
